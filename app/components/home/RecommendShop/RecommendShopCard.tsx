        ...
        <div className="flex justify-between gap-3 mb-4 max-sm:block items-center">
          ...
          <div className="w-[70%] px-5 py-4 max-sm:w-full">
            ...
            <div className="mb-5">
              ...
              <p className="text-black/70">{shuffledShop.formatted_address}</p>
            </div>
            <div className="mb-5 flex gap-7">
              <div>
                <p className="font-bold text-black/70">評価 {shuffledShop.rating}
                  <span className="font-normal text-gray-200 relative w-[84px] ml-2">
                    ...
                    <span 
                      ...
                      style={{ width: `${Math.floor(84 * (Number(shuffledShop.rating) / 5))}px`}}
                    >
                      ★★★★★
                    </span>
                  </span>
              ...
              <div>
                <p className="font-bold text-black/70">口コミ<span className="font-normal ml-1">{shuffledShop.user_ratings_total}件</span></p>
              </div>
            </div>
          </div>
        </div>
